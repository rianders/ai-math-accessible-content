  ...
  },
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        detail: 'Reading "x squared" vs. displaying x² requires proper encoding (LaTeX, MathML)'
      },
      {
...
const TitleSlide = ({ data }) => (
  <div className="slide-content title-slide">
    <div className="title-badge">RUTGERS UNIVERSITY</div>
    <h1>{data.title}</h1>
    <p className="subtitle">{data.subtitle}</p>
    <div className="presenter-info">
      <p className="presenter">{data.presenter}</p>
...
const AgendaSlide = ({ data }) => (
  <div className="slide-content agenda-slide">
    <h2>{data.title}</h2>
    <p className="duration-badge">Duration: {data.duration}</p>
    <div className="agenda-items">
      {data.sections.map((section, i) => (
        <div key={i} className="agenda-item">
          ...
          <div className="agenda-time">{section.time}</div>
        </div>
      ))}
    </div>
  </div>
...
const ObjectivesSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <p className="objectives-subtitle">{data.subtitle}</p>
    <ul className="objectives-list" role="list">
...
const AlertSlide = ({ data }) => (
  <div className="slide-content alert-slide">
    <h2>{data.title}</h2>
...
const ContentTypesSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <div className="content-types-grid">
      {data.items.map((item, i) => (
        <div key={i} className="content-type-card">
          <h3>{item.type}</h3>
          <p>{item.desc}</p>
        </div>
      ))}
    </div>
    {data.note && <p className="slide-note">{data.note}</p>}
  </div>
);

const ContentChallengesSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <p className="slide-intro">{data.intro}</p>
    <div className="content-challenges-grid">
      {data.items.map((item, i) => (
        <div key={i} className="content-challenge-card">
          <div className="challenge-header">
            <h3>{item.type}</h3>
            <p className="challenge-desc">{item.desc}</p>
          </div>
          <div className="challenge-edge">
            <span className="edge-label">Edge cases:</span>
            <span className="edge-text">{item.challenge}</span>
          </div>
        </div>
      ))}
    </div>
...
const ToolkitSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    {data.intro && <p className="slide-intro">{data.intro}</p>}
    <div className="toolkit-grid">
      {data.columns.map((col, i) => (
        <div key={i} className="toolkit-column">
          <h3>{col.heading}</h3>
          <ul role="list">
...
const StandardsSlide = ({ data }) => (
  <div className="slide-content standards-slide">
    <h2>{data.title}</h2>
    <p className="standards-subtitle">{data.subtitle}</p>
    <div className="principles-grid">
      {data.principles.map((p, i) => (
        <div key={i} className="principle-card" role="article">
          <span className="letter" aria-hidden="true">{p.letter}</span>
          <h3>{p.name}</h3>
          <p>{p.desc}</p>
        </div>
      ))}
...
const SuccessWithExamplesSlide = ({ data }) => (
  <div className="slide-content success-slide">
    <h2>{data.title}</h2>
    <p className="slide-intro">{data.intro}</p>
    <ul className="success-list" role="list">
      {data.items.map((item, i) => (
        <li key={i} className="success-item">
          <span className="success-icon" aria-hidden="true">{item.icon}</span>
          <span>{item.text}</span>
        </li>
      ))}
    </ul>
    <p className="slide-conclusion">{data.conclusion}</p>
    {data.placeholder && (
      <div className="placeholder-box">
        <div className="placeholder-header">📷 {data.placeholder.instruction}</div>
        <ul className="placeholder-suggestions">
          {data.placeholder.suggestions.map((s, i) => (
            <li key={i}>{s}</li>
          ))}
        </ul>
      </div>
...
const ProblemWithExamplesSlide = ({ data }) => (
      ...
      {data.items.map((item, i) => (
        <li key={i} className="problem-item">
          ...
          <div className="problem-content">
            ...
            <span className="problem-example">{item.example}</span>
          </div>
        </li>
      ))}
    </ul>
    <p className="slide-conclusion warning">{data.conclusion}</p>
    {data.placeholder && (
      <div className="placeholder-box">
        <div className="placeholder-header">📷 {data.placeholder.instruction}</div>
        <ul className="placeholder-suggestions">
...
const FocusWithExamplesSlide = ({ data }) => (
  <div className="slide-content focus-slide">
    <h2>{data.title}</h2>
    <p className="focus-subtitle">{data.subtitle}</p>
    ...
    {data.placeholder && (
      <div className="placeholder-box">
        <div className="placeholder-header">🖼️ {data.placeholder.instruction}</div>
        <ul className="placeholder-suggestions">
          {data.placeholder.suggestions.map((s, i) => (
            <li key={i}>{s}</li>
          ))}
...
const ScreenReaderDemoSlide = ({ data }) => (
  <div className="slide-content screen-reader-slide">
    <h2>{data.title}</h2>
    <p className="slide-subtitle">{data.subtitle}</p>
    <div className="demo-cards">
      {data.demos.map((demo, i) => (
        <div key={i} className={`demo-card status-${demo.status}`}>
...
const GapExampleSlide = ({ data }) => (
  <div className="slide-content gap-slide">
    <h2>{data.title}</h2>
    <p className="slide-subtitle">{data.subtitle}</p>
      ...
      {data.scenarios.map((s, i) => (
        <div key={i} className="scenario-card">
          ...
          <div className="scenario-comparison">
            <div className="scenario-builtin">
              <span className="label">Built-in tools say:</span>
              <span className="value">"{s.builtin}"</span>
            </div>
            <div className="scenario-needed">
              <span className="label">What's actually needed:</span>
              <span className="value">{s.needed}</span>
            </div>
          </div>
        </div>
      ))}
...
const SolutionSlide = ({ data }) => (
  <div className="slide-content solution-slide">
    <h2>{data.title}</h2>
    <p className="solution-subtitle">{data.subtitle}</p>
    <p className="slide-intro">{data.intro}</p>
    ...
    <p className="keypoint">{data.keypoint}</p>
    {data.formatNote && <p className="format-note">{data.formatNote}</p>}
    {data.pipelineNote && <p className="pipeline-note">Pipeline: {data.pipelineNote}</p>}
  </div>
);
...
const FrameworkSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <h3 className="framework-heading">{data.heading}</h3>
...
const WorkflowExampleSlide = ({ data }) => (
  <div className="slide-content workflow-example-slide">
    <h2>{data.title}</h2>
    <p className="slide-subtitle">{data.subtitle}</p>
    {data.placeholder && (
      <div className="placeholder-box large-placeholder">
        <div className="placeholder-header">📋 {data.placeholder.instruction}</div>
        
        <div className="example-structure">
          <div className="example-section">
            <h4>Input Image</h4>
            <p className="example-placeholder">{data.placeholder.example.inputImage}</p>
          </div>
          
          <div className="example-section">
            <h4>Prompt Used</h4>
            <p className="example-placeholder">{data.placeholder.example.promptUsed}</p>
          </div>
          
          <div className="example-section">
            <h4>AI Output</h4>
            <div className="ai-output-preview">
              <p><strong>LaTeX:</strong> <code>{data.placeholder.example.aiOutput.latex}</code></p>
              <p><strong>Screen Reader:</strong> "{data.placeholder.example.aiOutput.screenReader}"</p>
              <p><strong>Alt Text:</strong> "{data.placeholder.example.aiOutput.altText}"</p>
            </div>
          </div>
          
          <div className="example-section">
            <h4>Canvas Render</h4>
            <p className="example-placeholder">{data.placeholder.example.canvasRender}</p>
          </div>
        </div>
...
const PromptExampleSlide = ({ data }) => (
  <div className="slide-content prompt-example-slide">
    <h2>{data.title}</h2>
    <p className="prompt-subtitle">{data.subtitle}</p>
    <div className="prompt-box">
      <pre className="prompt-text">{data.prompt}</pre>
    </div>
    <p className="prompt-tip">💡 Save this as a Gemini Gem or ChatGPT Custom Instruction for reuse</p>
  </div>
);

const SetupSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <p className="slide-subtitle">{data.subtitle}</p>
    <div className="methods-list">
      {data.methods.map((m, i) => (
        <div key={i} className="method-card">
          ...
          <p className="method-benefit">→ {m.benefit}</p>
        </div>
      ))}
    </div>
  </div>
...
const DemoSlide = ({ data }) => (
  <div className="slide-content demo-slide">
    <h2>{data.title}</h2>
    <p className="demo-description">{data.description}</p>
    <ol className="demo-steps" role="list">
    ...
    {data.example && (
      <div className="demo-example">
        <div className="example-input">
          ...
          <span>{data.example.input}</span>
        </div>
        <div className="example-output">
          <span className="example-label">Output:</span>
          <pre>{data.example.output}</pre>
        </div>
      </div>
    )}
    {data.tips && (
...
const WorkflowSlide = ({ data }) => (
  <div className="slide-content">
    <h2>{data.title}</h2>
    <p className="slide-subtitle">{data.subtitle}</p>
    <ol className="workflow-steps" role="list">
      {data.steps.map((step, i) => (
        <li key={i} className={`workflow-step color-${step.color}`}>
...
const ActivitySlide = ({ data }) => (
  <div className="slide-content activity-slide">
    <h2>{data.title}</h2>
    <p className="activity-subtitle">{data.subtitle}</p>
    <ol className="activity-steps" role="list">
      {data.steps.map((step, i) => (
        <li key={i}>
    ...
    {data.timeboxed && <p className="timebox">⏱ Time: {data.timeboxed}</p>}
  </div>
);

const DiscussionSlide = ({ data }) => (
  <div className="slide-content discussion-slide">
    <h2>{data.title}</h2>
    <ul className="discussion-questions" role="list">
      {data.questions.map((q, i) => (
        <li key={i}>{q}</li>
      ))}
    </ul>
    {data.insight && <p className="insight">{data.insight}</p>}
  </div>
);

const StudentSlide = ({ data }) => (
  <div className="slide-content student-slide">
    <h2>{data.title}</h2>
    <p className="student-subtitle">{data.subtitle}</p>
    <div className="student-examples">
      {data.points.map((point, i) => (
        <div key={i} className="student-example">
          <p className="student-prompt">"{point.prompt}"</p>
          <p className="student-use">{point.use}</p>
        </div>
      ))}
    </div>
    {data.note && <p className="slide-note">{data.note}</p>}
...
const TakeawaysSlide = ({ data }) => (
  <div className="slide-content takeaways-slide">
    <h2>{data.title}</h2>
...
const ResourcesSlide = ({ data }) => (
  <div className="slide-content">
    ...
    <p className="closing-question">{data.question}</p>
  </div>
);

const UpcomingWorkshopsSlide = ({ data }) => (
  <div className="slide-content upcoming-workshops-slide">
    <h2>{data.title}</h2>
    <div className="workshop-categories">
      {data.categories.map((cat, i) => (
        <div key={i} className="workshop-category">
          <h3>{cat.heading}</h3>
          <p className="org-name">{cat.org}</p>
          {cat.sessions ? (
            ...
            <div className="placeholder-box small">
              <div className="placeholder-header">📅 {cat.placeholder.instruction}</div>
              <ul className="placeholder-suggestions">
                {cat.placeholder.suggestions.map((s, j) => (
                  <li key={j}>{s}</li>
                ))}
              </ul>
            </div>
...
const ClosingSlide = ({ data }) => (
  <div className="slide-content closing-slide">
    ...
    <p className="closing-org">{data.org}</p>
  </div>
);
...
export default function Presentation() {
  ...
  const getAct = (slideIndex) => {
    if (slideIndex < 8) return { num: 1, name: 'The Challenge' };
    if (slideIndex < 12) return { num: 2, name: 'The Gap' };
    if (slideIndex < 21) return { num: 3, name: 'The Solution' };
    if (slideIndex < 24) return { num: 4, name: 'Practice' };
    ...
    <div className="presentation-container">
      ...
      <header className="header" role="banner">
        ...
        <div className="nav-controls">
          <span className="act-indicator">Part {currentAct.num}: {currentAct.name}</span>
      ...
      <main id="main-content" role="main">
        <article className="slide" aria-label={`Slide ${currentSlide + 1}: ${slide.title}`}>
          <SlideComponent data={slide} />
        </article>
        
        <nav className="navigation" aria-label="Slide navigation">
          <button className="nav-btn" onClick={prevSlide} disabled={currentSlide === 0} aria-label="Previous slide">
            ← Previous
          </button>
          <button className="nav-btn" onClick={nextSlide} disabled={currentSlide === totalSlides - 1} aria-label="Next slide">
            Next →
          </button>
        </nav>
      </main>
      
      <div className="progress-bar" role="progressbar" aria-valuenow={currentSlide + 1} aria-valuemin={1} aria-valuemax={totalSlides}>
        <div className="progress-fill" style={{ width: `${((currentSlide + 1) / totalSlides) * 100}%` }} />
      </div>
      ...
      {isMenuOpen && (
        <div className="slide-menu-overlay" onClick={(e) => e.target === e.currentTarget && setIsMenuOpen(false)} role="dialog" aria-modal="true">
          <div className="slide-menu">
            ...
            <div className="slide-menu-section">
              ...
              <div className="slide-menu-list">
                {slides.slice(0, 8).map((s, i) => (
                  <button key={s.id} className={`slide-menu-item ${i === currentSlide ? 'active' : ''}`} onClick={() => goToSlide(i)}>
            ...
            <div className="slide-menu-section">
              ...
              <div className="slide-menu-list">
                {slides.slice(8, 12).map((s, i) => (
                  <button key={s.id} className={`slide-menu-item ${i + 8 === currentSlide ? 'active' : ''}`} onClick={() => goToSlide(i + 8)}>
                    <span className="slide-num">{i + 9}.</span>
                    <span>{s.title}</span>
                  </button>
                ))}
              </div>
            ...
            <div className="slide-menu-section">
              ...
              <div className="slide-menu-list">
                {slides.slice(12, 21).map((s, i) => (
                  <button key={s.id} className={`slide-menu-item ${i + 12 === currentSlide ? 'active' : ''}`} onClick={() => goToSlide(i + 12)}>
                    <span className="slide-num">{i + 13}.</span>
                    <span>{s.title}</span>
                  </button>
                ))}
              </div>
            ...
            <div className="slide-menu-section">
              ...
              <div className="slide-menu-list">
                {slides.slice(21, 24).map((s, i) => (
                  <button key={s.id} className={`slide-menu-item ${i + 21 === currentSlide ? 'active' : ''}`} onClick={() => goToSlide(i + 21)}>
                    <span className="slide-num">{i + 22}.</span>
                    <span>{s.title}</span>
                  </button>
                ))}
              </div>
            ...
            <div className="slide-menu-section">
              ...
              <div className="slide-menu-list">
                {slides.slice(24).map((s, i) => (
                  <button key={s.id} className={`slide-menu-item ${i + 24 === currentSlide ? 'active' : ''}`} onClick={() => goToSlide(i + 24)}>
